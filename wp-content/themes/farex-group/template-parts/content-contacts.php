		...
		<div class="row">
			<div class="col-md-3">
				<p class="contact-text">
					<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/pin.png" alt="pin">
					<?php the_field('address',4) ?>
				</p>
				<p class="contact-text">
					<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/phone.png" alt="pin">
				...
				<p class="contact-text">
					<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/envelope.png" alt="pin">
					<a href="mailto:<?php the_field('email',4); ?>"><?php the_field('email',4); ?></a>
				</p>
				<p class="contact-text">
					<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/clock.png" alt="pin">
					График работы:<br>
