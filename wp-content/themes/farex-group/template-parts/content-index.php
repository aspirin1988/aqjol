...
<div class="container-fluid main">
			...
			<?php  /*print_r($slider);*/ foreach($slider as $key=> $val): ?>
				<div class="item <?php if (!$key) echo 'active';  ?>">
					...
					<div class="carousel-caption custom-caption">
						<p>&#8220; <?=$val['img_title'];?> &#8221;</p>
						<p>
							<?php if (!$key) : ?><img class="image-caption"src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/fanera.png"alt="fanera"><?php endif;?>
	...
	<div class="row">
		<div class="col-md-12 devise">
			<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/business.png" alt="business">
			<p>
