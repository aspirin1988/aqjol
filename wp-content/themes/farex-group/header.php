...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/css/css/bootstrap.min.css" rel="stylesheet">
	<link href="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/css/style.css" rel="stylesheet">
	...
	<div class="row">
		...
		<div class="col-md-7 text-right ">
			<div class="number-telephone">
				<img src="<?php bloginfo('template_directory') ?>/wp-content/themes/aqjol/public/img/telephone.png" alt="telephone">
